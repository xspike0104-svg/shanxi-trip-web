...
const FALLBACK: SharedState = {
  itinerary: [
    ...
    { id: 34, day: 2, time: "17:30备", title: "枫林逸景紫御府烧烤摊（晚餐备选）", detail: "地址：枫林逸景紫御府小区右边摆摊；仅有地址信息，出发前确认摊位是否营业", done: 0, updatedAt: EMPTY_TIME, reviewUrl: "https://www.amap.com/search?query=%E6%9E%AB%E6%9E%97%E9%80%B8%E6%99%AF%E7%B4%AB%E5%BE%A1%E5%BA%9C&city=%E5%A4%A7%E5%90%8C" },
    ...
    { id: 33, day: 3, time: "18:30备", title: "鼓楼东街老火锅（晚餐备选）", detail: "位于大同古城鼓楼东街；D3古城深度游结束后可选，建议提前确认排队与营业状态", done: 0, updatedAt: EMPTY_TIME, reviewUrl: "https://www.dianping.com/shop/G4nreJkjBkvZ7fPq" },
